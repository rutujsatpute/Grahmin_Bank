...
class Bank
{
    ...
    public void title()
    {
        Console.WriteLine("Welcome to IG Grahmin Bank");
    }
    public void details()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            Console.WriteLine($"Enter the Gender of Customer {i + 1} Male / Female");
    ...
    public void randomuserid()
    {
        for (int i = 0; i < n; i++)
        {
            ...
            string userid = $"{fname}.{lname}{randomNum}";
            Console.WriteLine($"{customers[i].Firstname} userid: {userid}");
            customers[i].UserId = userid;
        }
    }
    public void show()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            {
                Console.WriteLine($"{customers[i].Firstname}\t\t{customers[i].Lastname}\t\t{customers[i].Village}\t\t{customers[i].DOB}\t\t{customers[i].Mobileno}\t\t{customers[i].UserId}");
            }
        }
    }
